 ...
 * @LastEditors: Z&N
 * @LastEditTime: 2024-12-05 15:29:26
 ...
 * @return {Object}
 */
function addDomDrag(useDraggableClass: { [x: string]: { offDraggable: () => void } }, targetDomName: string, dragDomName: any, el: any, binding: { isDrag: boolean | undefined }): object {
