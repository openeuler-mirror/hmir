...
#define IPMI_INTF_FREE_0_6_0 1

/* Define to 1 to enable FreeIPMI Bridging Support. */
#define IPMI_INTF_FREE_BRIDGING 1
...
#define PACKAGE_STRING "ipmitool 1.8.19"
